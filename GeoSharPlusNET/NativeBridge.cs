...
public static class NativeBridge {
  ...
  [DllImport(WinLibName,
             EntryPoint = "BALpossionDiskElimSample",
             CallingConvention = CallingConvention.Cdecl)]
  private static extern bool BALpossionDiskElimSampleWin(byte[] inBuffer,
                                                         int inSize,
                                                         double generalArea,
                                                         int dim,
                                                         int n,
  ...
  [DllImport(MacLibName,
             EntryPoint = "BALpossionDiskElimSample",
             CallingConvention = CallingConvention.Cdecl)]
  private static extern bool BALpossionDiskElimSampleMac(byte[] inBuffer,
                                                         int inSize,
                                                         double generalArea,
                                                         int dim,
                                                         int n,
                                                         out IntPtr outBuffer,
                                                         out int outSize);
  public static bool BALpossionDiskElimSample(byte[] inBuffer,
                                              int inSize,
                                              double generalArea,
                                              int dim,
                                              int n,
