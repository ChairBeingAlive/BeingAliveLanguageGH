...
public class BALorganBase : GH_Component {
  ...
  protected override void RegisterInputParams(GH_InputParamManager pManager) {
    pManager.AddPlaneParameter(
        "Plane", "pln", "Base plane to draw the organ.", GH_ParamAccess.item);
    pManager.AddIntegerParameter(
        "Base Number", "num", "Number of the organ in the initial phase.", GH_ParamAccess.item, 3);
  ...
  protected override void RegisterOutputParams(GH_OutputParamManager pManager) {
    pManager.AddTextParameter(
        "State", "state", "State of the organ (active or inactive).", GH_ParamAccess.item);
    pManager.AddCurveParameter("ExistingOrgan",
                               "exiOrg",
                               "Existing organs from current or previous years.",
                               GH_ParamAccess.list);
    pManager.AddCurveParameter(
        "NewOrgan", "newOrg", "New organs from the current year.", GH_ParamAccess.list);
    pManager.AddLineParameter("ExistingGrassyPart",
                              "exiGrass",
                              "Existing grassy part of the organ.",
                              GH_ParamAccess.list);
    pManager.AddLineParameter(
        "NewGrassyPart", "newGrass", "Newly grown grassy part of the organ.", GH_ParamAccess.list);
  ...
  /// <returns></returns>
  protected List<Line> DrawGrassOrRoot(Point3d pivot,
                                       Vector3d dir,
                                       int num = 2,
                                       double scale = 1,
                                       double proximateLen = 10,
                                       double openingAngle = 10) {
    var res = new List<Line>();

    double[] lengths = { proximateLen * 0.9 * scale,
                         proximateLen * 1.1 * scale,
...
public class BALorganTuft : BALorganBase {
  ...
  protected override System.Drawing.Bitmap Icon => Properties.Resources.balOrganTuft;
...
public class BALorganRhizome : BALorganTuft {
  ...
  protected override System.Drawing.Bitmap Icon => Properties.Resources.balOrganRhizome;
  ...
  protected override void RegisterInputParams(GH_InputParamManager pManager) {
    ...
    pManager.AddBooleanParameter(
        "Symmetric", "sym", "Symmetric or not.", GH_ParamAccess.item, true);
  }
...
public class BALorganGroundRunner : BALorganBase {
  ...
  protected override System.Drawing.Bitmap Icon => Properties.Resources.balOrganGroundRunner;
  ...
  public override void AppendAdditionalMenuItems(ToolStripDropDown menu) {
    ...
    Menu_AppendItem(menu,
                    " Above Ground",
                    (sender, e) =>
                        Menu.SelectMode(this, sender, e, ref organLocation, "aboveGround"),
                    true,
                    CheckDrawingMode("aboveGround"));
    Menu_AppendItem(menu,
                    " Below Ground",
                    (sender, e) =>
                        Menu.SelectMode(this, sender, e, ref organLocation, "belowGround"),
                    true,
...
public class BALorganCreepingShoot : BALorganBase {
  ...
  protected override System.Drawing.Bitmap Icon => Properties.Resources.balOrganCreepingShoot;
...
public class BALorganCushion : BALorganBase {
  ...
  protected override System.Drawing.Bitmap Icon => Properties.Resources.balOrganCushion;
...
public class BALorganTapRoot : BALorganBase {
  ...
  protected override System.Drawing.Bitmap Icon => Properties.Resources.balOrganTapRoot;
...
public class BALorganMultiRoot : BALorganBase {
  ...
  protected override System.Drawing.Bitmap Icon => Properties.Resources.balOrganMultiRoot;
...
public class BALorganBulb : BALorganBase {
  ...
  protected override System.Drawing.Bitmap Icon => Properties.Resources.balOrganBulb;
...
public class BALorganStemTuber : BALorganBase {
  ...
  protected override System.Drawing.Bitmap Icon => Properties.Resources.balOrganStemTuber;
...
public class BALorganHiddenReserved : BALorganBase {
  ...
  protected override System.Drawing.Bitmap Icon => Properties.Resources.balOrganHiddenReserved;
...
public class BALorganSucculentPlant : BALorganBase {
  ...
  protected override System.Drawing.Bitmap Icon => Properties.Resources.balOrganSucculentPlant;
