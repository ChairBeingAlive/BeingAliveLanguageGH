...
public static class SamplingUtils {
  static public List<Point3d> uniformSampling(ref SoilBase sBase, int num) {
    ...
    while (true) {
      pt2d =
          FastPoisson
              .GenerateSamples((float)(sBase.bnd.Width), (float)(sBase.bnd.Height), (float)approxR)
              .ToList();
...
public static class FastPoisson {
  ...
  public static IEnumerable<System.Numerics.Vector2>
  GenerateSamples(float width, float height, float radius) {
    ...
    while (activeSamples.Count != 0) {
      ...
      for (int i = 0; i < _k; i++) {
        ...
        isValid = IsGeneratedSampleValid(
            generatedSample, width, height, radius, cellSize, samples, accelerator);
  ...
  private static bool IsGeneratedSampleValid(System.Numerics.Vector2 generatedSample,
                                             float width,
                                             float height,
                                             float radius,
                                             float cellSize,
