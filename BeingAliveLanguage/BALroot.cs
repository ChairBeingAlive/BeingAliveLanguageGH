...
namespace BeingAliveLanguage
{
    ...
    public class BALRootPlanar : GH_Component
    {
        ...
        protected override System.Drawing.Bitmap Icon => SysUtils.cvtByteBitmap(Properties.Resources.balRootPlanar);
    ...
    public class BALRootOM : GH_Component
    {
        ...
        public override GH_Exposure Exposure => GH_Exposure.secondary;
        protected override System.Drawing.Bitmap Icon => SysUtils.cvtByteBitmap(Properties.Resources.balRootOrganicMatter);
    ...
    public class BALtreeRoot2d : GH_Component
    {
        ...
        protected override void RegisterOutputParams(GH_OutputParamManager pManager)
        {
            ...
            pManager.AddCurveParameter("RootDead", "rootD", "Dead roots in later phases of a tree's life.", GH_ParamAccess.list);
        }
        ...
        public override void AppendAdditionalMenuItems(ToolStripDropDown menu)
        {
            ...
            Menu_AppendSeparator(menu);
            Menu_AppendItem(menu, "Drawing Style:", (sender, e) => { }, false).Font = GH_FontServer.StandardItalic;
            Menu_AppendItem(menu, " Center Lines", (sender, e) => Menu.SelectMode(this, sender, e, ref drawingMode, "centerLine"), true, CheckDrawingMode("centerLine"));
            Menu_AppendItem(menu, " Fancy Bounds", (sender, e) => Menu.SelectMode(this, sender, e, ref drawingMode, "fancyBound"), true, CheckDrawingMode("fancyBound"));
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (tInfo.phase >= 1 && tInfo.phase < 9)
            {
                ...
                newRoot.Add(new Line(anchorPt + hVec * prevHorTapRootParam, hVec * curHorTapRootParam).ToNurbsCurve());
                newRoot.Add(new Line(anchorPt - hVec * prevHorTapRootParam, -hVec * curHorTapRootParam).ToNurbsCurve());
        ...
        /// </summary>
        private List<Curve> CreateFancyBound(List<Curve> centerLines, Point3d anchorPoint, double baseThickness, int phase)
        {
